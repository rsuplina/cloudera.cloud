...
DOCUMENTATION = """
    ...
    description:
        - Allows you to retrieve the API URL for a given CDP Public Cloud CAI/ML Workspace.
        - If the workspace is not found, the lookup returns the value of I(default).
        - Otherwise, the lookup entry will be an empty list.
        - If the workspace is not found or is ambiguous, the lookup will return an error.
    version_added: "3.2.0"
    options:
        _terms:
            description:
                - The name of the CAI/ML Workspace or list of workspace names to query.
...
RETURN = """
  _list:
    description: List of API URLs for the queried CAI/ML Workspaces
    type: list
    elements: str
"""
